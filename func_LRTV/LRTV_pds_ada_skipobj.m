function [X, histo, GAM1, GAM2, PPk, DDk, Cp, Cd] = LRTV_pds_ada_skipobj(T,Q,al,w,be,lam,delta,dom,Gam,rho,maxiter,tol,verb)
  ...
  for iter = 1:maxiter
    ...
    if mod(iter,verb) == 0
      fprintf('%d :: condition(%e) :: pdr(%e) :: gam(%e,%e), rho(%e) \n',iter,condition,pdr(iter),gam1,gam2,rho_t);
    end
    if condition < tol
      break;
    end
